...
export const LIGHT_THEME_COLOURS = {
  primary: '#5300b7',
  onPrimary: '#ffffff',
  primaryContainer: '#6d28b9',
  ...
  tertiaryFixed: '#ffcdbd',
  tertiaryFixedDim: '#f0bd8b',
  onTertiaryFixed: '#2c1600',
  onTertiaryFixedVariannt: '#623f18',
  error: '#ef4444',
  onError: '#ffffff',
...
export const DARK_THEME_COLOURS = {
  primary: '#d0bcff',
  onPrimary: '#3c0091',
...
// Helper to switch theme on demand
export const getThemeColors = (scheme: ColorSchemeName) => {
  return scheme === 'dark' ? DARK_THEME_COLOURS : LIGHT_THEME_COLOURS;
};
